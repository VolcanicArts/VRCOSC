...
{
    public static readonly Dictionary<LipParam, BlendedShape> SHAPES = new()
    {
        // Direct params
        { LipParam.JawRight, new DirectShape(LipShapeV2.JawRight) },
        { LipParam.JawLeft, new DirectShape(LipShapeV2.JawLeft) },
        { LipParam.JawForward, new DirectShape(LipShapeV2.JawForward) },
        { LipParam.JawOpen, new DirectShape(LipShapeV2.JawOpen) },
        { LipParam.MouthApeShape, new DirectShape(LipShapeV2.MouthApeShape) },
        { LipParam.MouthUpperRight, new DirectShape(LipShapeV2.MouthUpperRight) },
        { LipParam.MouthUpperLeft, new DirectShape(LipShapeV2.MouthUpperLeft) },
        { LipParam.MouthLowerRight, new DirectShape(LipShapeV2.MouthLowerRight) },
        { LipParam.MouthLowerLeft, new DirectShape(LipShapeV2.MouthLowerLeft) },
        { LipParam.MouthUpperOverturn, new DirectShape(LipShapeV2.MouthUpperOverturn) },
        { LipParam.MouthLowerOverturn, new DirectShape(LipShapeV2.MouthLowerOverturn) },
        { LipParam.MouthPout, new DirectShape(LipShapeV2.MouthPout) },
        { LipParam.MouthSmileRight, new DirectShape(LipShapeV2.MouthSmileRight) },
        { LipParam.MouthSmileLeft, new DirectShape(LipShapeV2.MouthSmileLeft) },
        { LipParam.MouthSadRight, new DirectShape(LipShapeV2.MouthSadRight) },
        { LipParam.MouthSadLeft, new DirectShape(LipShapeV2.MouthSadLeft) },
        { LipParam.CheekPuffRight, new DirectShape(LipShapeV2.CheekPuffRight) },
        { LipParam.CheekPuffLeft, new DirectShape(LipShapeV2.CheekPuffLeft) },
        { LipParam.CheekSuck, new DirectShape(LipShapeV2.CheekSuck) },
        { LipParam.MouthUpperUpRight, new DirectShape(LipShapeV2.MouthUpperUpRight) },
        { LipParam.MouthUpperUpLeft, new DirectShape(LipShapeV2.MouthUpperUpLeft) },
        { LipParam.MouthLowerDownRight, new DirectShape(LipShapeV2.MouthLowerDownRight) },
        { LipParam.MouthLowerDownLeft, new DirectShape(LipShapeV2.MouthLowerDownLeft) },
        { LipParam.MouthUpperInside, new DirectShape(LipShapeV2.MouthUpperInside) },
        { LipParam.MouthLowerInside, new DirectShape(LipShapeV2.MouthLowerInside) },
        { LipParam.MouthLowerOverlay, new DirectShape(LipShapeV2.MouthLowerOverlay) },
        { LipParam.TongueLongStep1, new DirectShape(LipShapeV2.TongueLongStep1) },
        { LipParam.TongueLongStep2, new DirectShape(LipShapeV2.TongueLongStep2) },
        { LipParam.TongueDown, new DirectShape(LipShapeV2.TongueDown) },
        { LipParam.TongueUp, new DirectShape(LipShapeV2.TongueUp) },
        { LipParam.TongueRight, new DirectShape(LipShapeV2.TongueRight) },
        { LipParam.TongueLeft, new DirectShape(LipShapeV2.TongueLeft) },
        { LipParam.TongueRoll, new DirectShape(LipShapeV2.TongueRoll) },
        { LipParam.TongueUpLeftMorph, new DirectShape(LipShapeV2.TongueUpLeftMorph) },
        { LipParam.TongueUpRightMorph, new DirectShape(LipShapeV2.TongueUpRightMorph) },
        { LipParam.TongueDownLeftMorph, new DirectShape(LipShapeV2.TongueDownLeftMorph) },
        { LipParam.TongueDownRightMorph, new DirectShape(LipShapeV2.TongueDownRightMorph) },
