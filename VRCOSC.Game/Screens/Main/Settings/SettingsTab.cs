        ...
        Children = new Drawable[]
        {
            ...
            new FillFlowContainer
            {
                ...
                Children = new Drawable[]
                {
                    ...
                    new SettingsToggle(configManager.GetBindable<bool>(VRCOSCSetting.VRCAutoStart), "Auto Start/Stop", "Allows VRCOSC to start/stop modules when VRChat opens/closes"),
