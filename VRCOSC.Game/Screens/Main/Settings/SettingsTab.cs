        ...
        Children = new Drawable[]
        {
            ...
            new FillFlowContainer
            {
                ...
                Children = new Drawable[]
                {
                    ...
                    new SettingsToggle(configManager.GetBindable<bool>(VRCOSCSetting.VRCAutoStart), "Auto Start with VRChat", "Allows VRCOSC to start modules when VRChat opens"),
                    new SettingsToggle(configManager.GetBindable<bool>(VRCOSCSetting.VRCAutoStop), "Auto Stop with VRChat", "Allows VRCOSC to stop modules when VRChat closes"),
