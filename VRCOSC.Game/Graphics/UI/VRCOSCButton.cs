...
public partial class VRCOSCButton : ClickableContainer
{
    ...
    protected VRCOSCButton()
    {
        InternalChild = Content = new Container
        {
            ...
            Masking = true,
            EdgeEffect = EdgeEffects.NoShadow,
        };
    ...
    protected override bool OnHover(HoverEvent e)
    {
        if (ShouldAnimate)
        {
            Content.TransformTo(nameof(EdgeEffect), EdgeEffects.HoverShadow, 100, Easing.OutCirc);
    ...
    protected override void OnHoverLost(HoverLostEvent e)
    {
        if (ShouldAnimate)
        {
            Content.TransformTo(nameof(EdgeEffect), EdgeEffects.NoShadow, 100, Easing.OutCirc);
