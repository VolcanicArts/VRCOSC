...
// Taken from https://github.com/ppy/osu/blob/1122ee967c346b2b3454ac0a19a928e723717aff/osu.Game/Screens/Edit/Compose/Components/RectangularPositionSnapGrid.cs
public partial class RectangularPositionSnapGrid : CompositeDrawable
{
    ...
    private readonly LayoutValue gridCache = new(Invalidation.RequiredParentSizeToFit);
    ...
    private void generateGridLines(Direction direction, float startPosition, float endPosition, float step)
    {
        ...
        generatedLines.First().Alpha = 1f;
        generatedLines.Last().Alpha = 1f;
