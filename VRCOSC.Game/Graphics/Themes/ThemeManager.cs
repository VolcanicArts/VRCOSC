    ...
    {
        {
            ColourTheme.Dark, new Dictionary<ThemeAttribute, Color4>
            {
                ...
                { ThemeAttribute.Lighter, Color4Extensions.FromHex(@"AAAAAA") },
        ...
        },
        {
            ColourTheme.SpaceGrey, new Dictionary<ThemeAttribute, Color4>
            {
                ...
                { ThemeAttribute.Light, Color4Extensions.FromHex(@"a7adba").Darken(0.5f) },
                { ThemeAttribute.Lighter, Color4Extensions.FromHex(@"c0c5ce").Darken(0.5f) },
                { ThemeAttribute.Success, Color4Extensions.FromHex(@"88B300") },
                { ThemeAttribute.Pending, Color4Extensions.FromHex(@"FFCC22") },
                { ThemeAttribute.Failure, Color4Extensions.FromHex(@"ED1121") },
                { ThemeAttribute.Action, Color4Extensions.FromHex(@"44AADD") },
        ...
        },
        {
            ColourTheme.NightSky, new Dictionary<ThemeAttribute, Color4>
            {
                ...
                { ThemeAttribute.Light, Color4Extensions.FromHex(@"546bab").Lighten(0.15f) },
                { ThemeAttribute.Lighter, Color4Extensions.FromHex(@"546bab").Lighten(0.25f) },
                { ThemeAttribute.Success, Color4Extensions.FromHex(@"88B300") },
                { ThemeAttribute.Pending, Color4Extensions.FromHex(@"FFCC22") },
                { ThemeAttribute.Failure, Color4Extensions.FromHex(@"ED1121") },
                { ThemeAttribute.Action, Color4Extensions.FromHex(@"44AADD") },
        ...
        },
        {
            ColourTheme.Purple, new Dictionary<ThemeAttribute, Color4>
            {
                ...
                { ThemeAttribute.Light, Color4Extensions.FromHex(@"d896ff").Darken(0.5f) },
                { ThemeAttribute.Lighter, Color4Extensions.FromHex(@"efbbff").Darken(0.5f) },
                { ThemeAttribute.Success, Color4Extensions.FromHex(@"88B300") },
                { ThemeAttribute.Pending, Color4Extensions.FromHex(@"FFCC22") },
                { ThemeAttribute.Failure, Color4Extensions.FromHex(@"ED1121") },
                { ThemeAttribute.Action, Color4Extensions.FromHex(@"44AADD") },
