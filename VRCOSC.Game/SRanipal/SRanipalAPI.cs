...
public static class SRanipalAPI
{
    [DllImport("SRanipal", EntryPoint = "Initial")]
    private static extern Error initialise(int anipalType, IntPtr config);

    [DllImport("SRanipal", EntryPoint = "Release")]
    private static extern Error release(int anipalType);

    [DllImport("SRanipal", EntryPoint = "GetEyeData_v2")]
    private static extern Error getEyeDataV2(ref EyeDataV2 data);

    [DllImport("SRanipal", EntryPoint = "GetLipData_v2")]
    private static extern Error getLipDataV2(ref LipDataV2 data);
    ...
    public static Error Initialise(int anipalType) => initialise(anipalType, IntPtr.Zero);
    ...
    /// <param name="anipalType">The index of an anipal module.</param>
    /// <returns>Indicates the resulting <see cref="Error"/> status of this method.</returns>
    public static Error Release(int anipalType) => release(anipalType);

    /// <summary>
    /// Gets data from anipal's Eye module.
    /// </summary>
    /// <param name="data"><see cref="EyeDataV2"/></param>
    /// <returns>Indicates the resulting <see cref="Error"/> status of this method.</returns>
    ...
    /// <returns>Indicates the resulting <see cref="Error"/> status of this method.</returns>
    public static Error GetLipData(ref LipDataV2 data) => getLipDataV2(ref data);
}
