...
namespace VRCOSC
{
    public class WebRequest : IDisposable
    {
        ...
        /// Form parameters.
        /// </summary>
        private readonly Dictionary<string, string> formParameters = new();
        ...
        /// </summary>
        protected virtual string UserAgent => "VRCOSC";
        ...
        protected virtual Task Complete(Exception? e = null)
        {
            ...
            if (e != null)
            {
                ...
                if (ResponseStream is { CanSeek: true, Length: > 0 })
                {
